...
<Accordion title="L-hat: Manifold Curvature">
...
<Accordion title="A-hat: Adversarial Pressure">
...
<Accordion title="S-hat: Signal Health">
...
<Accordion title="Gamma-hat: Dissipation">
