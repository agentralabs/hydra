...
<CardGroup cols={3}>
  <Card title="Content Creation" icon="palette">38 entries</Card>
  <Card title="Developer" icon="code">30 entries</Card>
  <Card title="Finance" icon="chart-line">26 entries</Card>
  <Card title="Architecture" icon="building">10 entries</Card>
  <Card title="Security" icon="shield">10 entries</Card>
  <Card title="Physics" icon="atom">10 entries</Card>
</CardGroup>
